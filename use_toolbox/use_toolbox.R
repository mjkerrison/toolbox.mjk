...
download_from_github(c(
  ...
  'R/initialise_project.R',
  'R/more_infix_operators.R',
  'R/utilities_for_databases.R',
  'R/utilities_for_dates.R',
  'R/utilities_for_Excel.R',
  'R/utilities_for_ggplot.R',
  'R/utilities_for_logging.R',
  'R/utilities_for_openai.R',
  'R/utilities_for_paths.R',
  'R/utilities_for_Powerpoint.R',
  'R/utilities_for_set_operations.R',
